...
public class OrderService : IOrderService
{
    ...
    public async Task<ServiceResult<Order>> CreateOrderAsync(int customerId, IReadOnlyList<NewOrderLine> lines)
    {
        ...
        var inputError = ValidateOrderLines(lines);
        ...
        var errors = await ValidateAndAddOrderItemsAsync(order, lines);
    ...
    private async Task<IReadOnlyList<string>> ValidateAndAddOrderItemsAsync(
        Order order,
